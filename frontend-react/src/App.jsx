...
function App() {
  ...
  const analyzeBottleneck = (cpu, gpu) => {
    ...
    if (cores <= 4 && gpuPower > 80000) {
      ...
      message  = '✅ Balanced Build: Your CPU and GPU work perfectly together!';
    }
    ...
    <>
      ...
      <main>
        ...
        <section className="hero">
          <div className="hero-tag">🤖 Powered by Random Forest AI</div>
        ...
        <section className="about-section" id="about">
          ...
          <div className="about-bio">
            ...
            <p>
              ...
              I'm always building, always learning.
            </p>
          </div>
      ...
      <footer className="site-footer" id="contact">
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a href={CONTACT.github}   target="_blank" rel="noreferrer" className="social-btn" title="GitHub">
                <GithubIcon />
              </a>
              <a href={CONTACT.facebook} target="_blank" rel="noreferrer" className="social-btn" title="Facebook">
                <FacebookIcon />
              </a>
              <a href={CONTACT.linkedin} target="_blank" rel="noreferrer" className="social-btn" title="LinkedIn">
                <LinkedinIcon />
              </a>
              <a href={`https://wa.me/94${CONTACT.whatsapp.replace(/^0/, '')}`} target="_blank" rel="noreferrer" className="social-btn" title="WhatsApp">
                <WhatsappIcon />
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <p>Built with ❤️ using React · Node.js · Python · MongoDB</p>
        </div>
      </footer>
    </>
  );
